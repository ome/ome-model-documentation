...
extlinks = {
    ...
    'ome-files' : (oo_root + '/ome-files/%s', None), 
    'partners' : (oo_root + '/commercial-partners/%s', None),
    'schema' : (oo_root + '/Schemas/%s', None),
    'citing' : (oo_root + '/citing-ome/%s', None),
    # Help links
    'help' : (help_root + '/%s', None),
    # Miscellaneous links
    'snapshot' : (cvs_root + '/snapshots/%s', None),
    'zeroc' : ('https://zeroc.com/%s', None),
    'zerocforum' : ('https://forums.zeroc.com/forum/%s', None),
    'zerocdoc' : ('https://doc.zeroc.com/%s', None),
    'djangodoc' : ('https://docs.djangoproject.com/en/1.8/%s', None),
    'doi' : ('http://dx.doi.org/%s', None),
    'pypi': ('https://pypi.python.org/pypi/%s', None),
    # Github links
    'source' : (bf_github_root + 'blob/'+ branch + '/%s', None),
    'sourcedir' : (bf_github_root + 'tree/'+ branch + '/%s', None),
    'bf_source' : (bf_github_root + 'blob/'+ branch + '/%s', None),
    'bf_sourcedir' : (bf_github_root + 'tree/'+ branch + '/%s', None),
    # API
    'javadoc' : ("https://javadoc.io/doc/org.openmicroscopy/ome-xml/%s", None),
    # Doc links
    'devs_doc' : (docs_root + '/contributing/%s', None),
    'omero_doc' : (docs_root + '/latest/omero/%s', None),
    'bf_doc' : (docs_root + '/latest/bio-formats/%s', None),
    'schema_doc' : (oo_root + '/Schemas/Documentation/Generated/OME-' + model_version + '/%s', None),
    # Downloads
    'bf_downloads' : (oo_root + '/bio-formats/downloads/%s', None),
    'cpp_downloads' : (oo_root + '/ome-files/downloads/%s', None),
    'image_downloads' : (downloads_root + '/images/%s', None),
    'ometiff_downloads' : (downloads_root + '/images/OME-TIFF/' + model_version + '/%s', None),
    'omexml_downloads' : (downloads_root + '/images/OME-XML/' + model_version + '/%s', None),
    }
